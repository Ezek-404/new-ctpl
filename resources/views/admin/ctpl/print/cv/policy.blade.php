<style>
    ...
    @media print {
        ...
        .p_policy-no   { top: 1.65in; left: 7.43in; }
        .p_assured     { top: 2in; left: 0.60in; width: 5in; }
        .p_address     { top: 2.32in; left: 0.60in; width: 4in; }
        .p_date-issued { top: 2.28in; left: 5.60in; }
        .p_date-from   { top: 2.75in; left: 5.60in; }
        .p_date-to     { top: 2.75in; left: 7.33in; }
        
        .p_year        { top: 3.26in; left: 0.60in; }
        .p_make        { top: 3.25in; left: 1.95in; }
        .p_type        { top: 3.25in; left: 3.8in; }
        .p_color       { top: 3.24in; left: 5.54in; width: 1.3in; }
        .p_file        { top: 3.23in; left: 7.22in; }
        
        .p_plate       { top: 3.59in; left: 0.60in; }
        .p_chassis     { top: 3.59in; left: 1.95in; }
        .p_engine      { top: 3.59in; left: 3.8in; }
